...
setTerrainGrid 50;    //(Hi)12.5 or 25(Med) or 50(Low)  Grass off
...
DZE_GodModeBase = true; //indestructable bases
...
DZE_PlotPole = [80,95];	
DZE_BuildingLimit = 200;//how many items can a player build
...
//snow
snowchance = 10; //5% chance to snow on server start/restart
