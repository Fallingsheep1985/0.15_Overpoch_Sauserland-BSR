...
//			s_clothes = player addAction [("" + ("Take Clothes") + ""), "scripts\zupa\skins\removeclothes.sqf",cursorTarget, 1, false, true, "",""];
		s_clothes = player addAction [("" + ("Take Clothes") + ""), "scripts\zupa\skins\recoverskin.sqf",cursorTarget, 1, false, true, "",""];
		};
	} else {
...
//	_isaCar = _cursorTarget isKindOf "Car";
	//////////////////////NOS
	_isaCar = _typeOfCursorTarget in ["car_hatchback","car_sedan","datsun1_civil_1_open","datsun1_civil_2_covered","datsun1_civil_3_open","hilux1_civil_1_open","hilux1_civil_2_covered","hilux1_civil_3_open_EP1",
